...
*(First derivatives. Note the same divide-style move as 2(a): the arctan of a ratio recovers an angle, and its derivative brings in the familiar the familiar $x\dot{y}-y\dot{x}$ numerator.)* 
